...
public class MultiColumnXListView extends MultiColumnListView implements OnScrollListener {
	 ...
	 * @param context
	 */
	public MultiColumnXListView(Context context) {
		super(context);
		initWithContext(context);
	}

	public MultiColumnXListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public MultiColumnXListView(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initWithContext(Context context) {
		...
		mHeaderViewContent =
				(RelativeLayout) mHeaderView.findViewById(R.id.xlistview_header_content);
