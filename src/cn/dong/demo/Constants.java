...
public class Constants {
    public static final String API_KEY = "orwD5uEwNlRZuFPERrUnrqym";
    public static final String SECRET_KEY = "rdGDfelpGVSVVtqVoOfmtBuRLWahX26k";
    public static final String SECRET_KEY16 = "rdGDfelpGVSVVtqV";
