...
public class TestFragment extends Fragment {
	private static final String[] colors = { "#99CCB4", "#AABDB4", "#B3AD9B", "#FC9D9D",
			"#27C4C4" };
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		button2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				FragmentUtil.replaceFragment(getChildFragmentManager(),
						ChildFragment.class, new Bundle(), R.id.childContainer, false);
			}
		});
		return view;
	}
