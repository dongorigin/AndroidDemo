...
/**
 * @Description Fragment跳转控制工具
 * @author dong
 * @date 2014-1-14 下午5:02:22
 */
public class FragmentUtil {

	public static void startFragment(FragmentManager fm,
			Class<? extends Fragment> fragmentClass, Bundle args) {
		startFragment(fm, fragmentClass, args, R.id.container);
	}

	public static void startFragment(FragmentManager fm,
			Class<? extends Fragment> fragmentClass, Bundle args, int containerId) {
	...
	public static void replaceFragment(FragmentManager fm,
			Class<? extends Fragment> fragmentClass, Bundle args, boolean isAddToBackStack) {
	...
	private void tagTest(FragmentManager fm, Class<? extends Fragment> fragmentClass,
			Bundle args, int containerId, String tag) {
		FragmentTransaction transaction = fm.beginTransaction();
